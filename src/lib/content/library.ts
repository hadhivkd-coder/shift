...
export const LIBRARY_ARTICLES: LibraryArticle[] = [
  ...
  },
  {
    ...
    category: 'Cravings',
    title: 'The 10-Minute Reset: Decoupling Stress from Cravings',
    readTime: '3 min read',
    summary: 'A physiological step-by-step method to navigate cravings during their 10–20 minute peak window.',
    content: [
      'Cravings are not moral failures; they are neurochemical waves that follow a predictable 10–20 minute rise and fall. When tired, stressed, or dehydrated, dopamine levels drop, prompting urgent urges for rapid refined sugar.',
      'Fighting a craving with white-knuckle willpower triggers counterproductive cortisol spikes that intensify the urge. Instead, deploy The 10-Minute Reset from The 20 KG Blueprint.',
      'Step 1: Drink 300ml of cool water with a pinch of lemon. Step 2: Eat a small protein bridge such as 2 boiled eggs, roasted chana, or curd. Step 3: Shift your physical environment or walk for 10 minutes. In the vast majority of cases, the 10–20 minute dopamine wave crests and subsides naturally.',
    ],
    keyTakeaways: [
      'Cravings follow a natural 10–20 minute neurochemical wave; delaying response allows the impulse to settle.',
      'Willpower is a depleting resource; use hydration and environmental friction instead.',
      'If you still desire the food after the 10-minute reset, enjoy a mindful portion without guilt.',
    ],
  },
  {
